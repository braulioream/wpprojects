...
class WC_POS_Admin_Notices extends WC_Admin_Notices {
	...
	public static function add_notice( $name, $force_save = false ) {
		$notices = array_unique( array_merge( (array) get_option( 'wc_pos_admin_notices', array() ), array( $name ) ) );
	...
	public static function remove_notice( $name, $force_save = false ) {
		$notices = array_diff( (array) get_option( 'wc_pos_admin_notices', array() ), array( $name ) );
		update_option( 'wc_pos_admin_notices', $notices );
	}
	...
	public static function has_notice( $name ) {
		return in_array( $name, (array) get_option( 'wc_pos_admin_notices', array() ) );
	}
	...
	public static function add_notices() {
		$notices = (array) get_option( 'wc_pos_admin_notices', array() );
		if ( $notices ) {
