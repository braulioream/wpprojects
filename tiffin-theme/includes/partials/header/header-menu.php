			...
			<div class="col span_9 col_last">
				...
				if ( ! empty( $nectar_options['enable-cart'] ) && $nectar_options['enable-cart'] === '1' ) {
					...
					if ( $woocommerce ) {
						...
						<a id="mobile-cart-link" href="<?php echo esc_url( wc_get_cart_url() ); ?>"><i class="icon-salient-cart"></i><div class="cart-wrap"><span><?php echo tiffin_cart_contents_count() ?> </span></div></a>
						<?php
					}
				}
				...
				?>
					...
					<nav>
						...
						<?php do_action("tiffin_header_menu_action"); ?>
